...
from .views import ProfuctDetailView, product_detail_view, product_list_create_view, list_Create, product_update_view,\
      product_destroy_view,  product_mixins_view, ProductDetailView
...
urlpatterns = [
    ...
    path('<int:pk>/update/', product_update_view, name='product_edit'),
    ...
    path('', product_list_create_view, name='product_list_create'),
